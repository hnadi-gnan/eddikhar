...
#this is copied from odoo inventory of v14 the idea is to ceate an inventory
...
'''
class YearlyAppraisal(models.Model):
    _name = "hr.appraisal"
    _description = "Appraisal Run"
    _order = "date desc, id desc"
    _inherit = ['mail.thread', 'mail.activity.mixin']

    name = fields.Char(
        'Appraisal Run Ref', default="Appraisal Run",
...
class EmployeeAppraisalRunLine(models.Model):
    _name = "hr.appraisal.run.line"
